...
public class K8sSecret {
    ...
    public K8sSecret(Map<String, Object> Annotations, String ConfigurationOwner, String ConfigurationOwnerId, List<K8sConfigurationOwnerResource> ConfigurationOwners, String CreationDate, Map<String, Object> Data, Boolean IsUsed, Map<String, Object> Labels, String Name, String Namespace, String SecretType, String UID) {
