...
public class K8sRoleBinding {
    ...
    public K8sRoleBinding() {
    }

    public K8sRoleBinding(String creationDate, Boolean isSystem, String name, String namespace, RoleRef roleRef, List<Subject> subjects, String uid) {
