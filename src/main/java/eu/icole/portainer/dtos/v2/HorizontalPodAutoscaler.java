...
import eu.icole.portainer.dtos.v2.HorizontalPodAutoscalerSpec;
import eu.icole.portainer.dtos.v2.HorizontalPodAutoscalerStatus;
...
public class HorizontalPodAutoscaler {
    ...
    public HorizontalPodAutoscaler(Map<String, Object> annotations, String apiVersion, String creationTimestamp, Integer deletionGracePeriodSeconds, String deletionTimestamp, List<String> finalizers, String generateName, Integer generation, String kind, Map<String, Object> labels, List<ManagedFieldsEntry> managedFields, String name, String namespace, List<OwnerReference> ownerReferences, String resourceVersion, String selfLink, HorizontalPodAutoscalerSpec spec, HorizontalPodAutoscalerStatus status, String uid) {
