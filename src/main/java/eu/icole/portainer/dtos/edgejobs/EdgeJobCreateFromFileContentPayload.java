...
public class EdgeJobCreateFromFileContentPayload {
    ...
    public EdgeJobCreateFromFileContentPayload() {
    }

    public EdgeJobCreateFromFileContentPayload(String cronExpression, List<Integer> edgeGroups, List<Integer> endpoints, String fileContent, String name, Boolean recurring) {
