...
public class ComposeStackFromGitRepositoryPayload {
    ...
    public ComposeStackFromGitRepositoryPayload() {
    }

    public ComposeStackFromGitRepositoryPayload(List<String> additionalFiles, AutoUpdateSettings autoUpdate, String composeFile, List<Pair> env, Boolean fromAppTemplate, String name, Boolean repositoryAuthentication, String repositoryPassword, String repositoryReferenceName, String repositoryURL, String repositoryUsername, Boolean tlsskipVerify) {
