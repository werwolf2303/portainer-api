...
import eu.icole.portainer.dtos.endpoints.RegistryAccessPayload;
...
public class EndpointsRegistriesPut implements Endpoint<RegistryAccessPayload, Object> {
    @Override
    public String url() {
        return "/endpoints/%s/registries/%s";
    }

    @Override
    public RequestBody body(RegistryAccessPayload data, Gson gson) throws Exception {
