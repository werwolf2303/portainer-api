...
import eu.icole.portainer.dtos.endpoints.EndpointSettingsUpdatePayload;
...
public class EndpointsSettings implements Endpoint<EndpointSettingsUpdatePayload, eu.icole.portainer.dtos.portainer.Endpoint> {
    @Override
    public String url() {
        return "/endpoints/%s/settings";
    }

    @Override
    public RequestBody body(EndpointSettingsUpdatePayload data, Gson gson) throws Exception {
