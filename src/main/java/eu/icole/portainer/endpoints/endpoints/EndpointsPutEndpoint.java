...
public class EndpointsPutEndpoint implements Endpoint<EndpointUpdatePayload, eu.icole.portainer.dtos.portainer.Endpoint> {
    @Override
    public String url() {
        return "/endpoints/%s";
    }
    ...
    @Override
    public RequestBody body(EndpointUpdatePayload data, Gson gson) {
