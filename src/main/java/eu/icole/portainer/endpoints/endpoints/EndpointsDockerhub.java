...
import eu.icole.portainer.dtos.endpoints.DockerhubStatusResponse;
...
public class EndpointsDockerhub implements Endpoint<Object, DockerhubStatusResponse> {
    @Override
    public String url() {
        return "/endpoints/%s/dockerhub/%s";
    }
    ...
    @Override
    public DockerhubStatusResponse result(Gson gson, Response response) throws IOException, PortainerException {
        ...
        return gson.fromJson(response.body().string(), DockerhubStatusResponse.class);
    }
